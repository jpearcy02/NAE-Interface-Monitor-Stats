...
class Agent(NAE):
    ...
    def __init__(self):
        ...
        for port in self.port_list:
            ...
            uri = '/rest/v10.13/system/interfaces/{}?attributes=statistics.rx_bytes'.format(
                port.replace("/", "%2F")
            )
    ...
    def find_monitored_ports(self):
        ...
        mac_table_uri = '/rest/v10.13/system/vlans/{}/macs?attributes=&depth=2&selector=status'.format(
            monitored_vlan
        )
